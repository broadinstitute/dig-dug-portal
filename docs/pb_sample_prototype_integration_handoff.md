...
- Local review URL:
  `http://127.0.0.1:8091/pb_sample.html?query=BCH-00-00000-01`
...
The next stage is to copy the PB Sample view into `bch-prototype`, replace
`mockData.js` with BioIndex-backed data, and verify all cross-page links. BioIndex
index names and response schemas are intentionally not specified here because
they have not yet been verified against the test server.
