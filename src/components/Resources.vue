<template>
    <div>
        ...
        <div class="page-info-wrapper">
            <div v-for="(row, i) in videoResourcesList" class="resource-item-wrapper">
                <h3 :id="'resource_content_title'+row.nid">
                    <a href="javascript:;" v-on:click="setSeletedResource(row.nid)">{{row.title}}</a>
                </h3>
                <div>
                ...
                <div
                    ...
                    :class="selectedResource != null && row.nid == selectedResource? '':'hidden' "
                >
                    ...
                    <div class="resources-iframe-wrapper">
                        <iframe
                            width="560"
                            height="315"
                            :src="'https://www.youtube.com/embed/'+ row.field_video_id"
                            frameborder="0"
        ...
        <div class="page-info-wrapper">
            <div v-for="(row, i) in documentResourcesList" class="resource-item-wrapper">
                <h3 :id="'resource_content_title'+row.nid">
                    <a href="javascript:;" v-on:click="setSeletedResource(row.nid)">{{row.title}}</a>
                </h3>
                <div>
