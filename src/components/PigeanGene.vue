  ...
  data() {
      return {
        ...
        pigeanConfig: {
            ...
            "y axis field labels": ["GWAS support (HuGE score enhanced(?) with gene set support)","HuGE score"],
            "primary y axis field": "GWAS_support",
            "convert y -log10": "false",
            "y axis label": "HuGE score vs GWAS support",
            "x axis label": "",
            "beta field": "null",
            "hover content": ["Phenotype", "Factor","Combined_GWAS_gene_sets", "GWAS_support", "Gene_set_support", "HuGE_Score"],
