    ...
    <div style="display: flex; flex-direction: column; gap: 10px">
        <template v-if="false">
            <div style="display: flex; gap: 10px; align-items: center">
                ...
                <select
                    v-model="selectedBI"
                    @change="selectBioIndex($event.target.value)"
                >
            ...
            >
                <template #cell(datasetId)="data">
                    <button
                        v-if="data.item.datasetId !== datasetId"
                        @click="selectDataset(data.item.datasetId)"
                    >
                        Select
                    </button>
            ...
            >
                ...
                <select
                    v-model="layout"
                    @change="selectLayout($event.target.value)"
                >
                    <option
                        v-for="layout of layoutOptions"
                        :value="layout.value"
                    >
                        {{ layout.name }}
                    </option>
        ...
        <template v-if="false">
            ...
            <!-- datasets dropdown -->
            <select
                @change="selectDataset(data.item.datasetId)"
                v-model="datasetId"
            >
                <option :value="null">--Select--</option>
                <option
                    v-for="item in singleCellMetadata"
                    :value="item.datasetId"
                >
                    {{ item.tissue }} ({{
                        item.totalCells.toLocaleString()
                    }}
                    cells)
                </option>
            </select>
        ...
        >
            ...
            <div
                ...
                "
            >
                <research-single-cell-info v-if="metadata" :data="metadata" />
                <div
                    v-if="dataReady"
                    class=""
                ...
                >
                        ...
                        >
                            ...
                            >
                                ...
                                <research-umap-plot-gl
                                    ...
                                    :colorByField="
                                        cellCompositionVars.colorByField
                                    "
                                    :hoverFields="[]"
                                    :highlightLabel="
                                        cellCompositionVars.highlightLabel
                                    "
                                    :highlightLabels="
                                        cellCompositionVars.highlightLabels
                                    "
                                    :width="400"
                                    :height="400"
                                />
                            ...
                            <div
                                ...
                                "
                            >
                                <strong style="font-size: 16px; margin: 0 0 5px"
                                    >Color By</strong
                                >
                                <div
                                    style="
                                ...
                                >
                                    <select
                                        style="width: 100%"
                                        @change="
                                            selectColorBy($event.target.value)
                                        "
                                        v-model="
                                            cellCompositionVars.colorByField
                                        "
                                    ...
                                    >
                                        <research-single-cell-selector
                                            ...
                                            :colors="labelColors"
                                            @on-update="
                                                handleSelectorUpdate($event)
                                            "
                                            @on-hover="
                                                handleSelectorHover($event)
                                            "
                                        />
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <strong style="font-size: 16px"
                                        >{{
                                            geneExpressionVars.selectedGene
                                                ? `${geneExpressionVars.selectedGene}`
                                                : "Gene"
                                        }}
                                        Expression</strong
                                ...
                                <div style="position: relative; width: 100%">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="gradient"
                                            :style="`background: linear-gradient(to right, ${colorScalePlasmaColorsArray}); height:5px;`"
                                        ></div>
                                        <div
                                            style="display: flex"
                                            class="marks"
                                ...
                                >
                                    <div style="display: flex; gap: 5px">
                                        <input
                                            ...
                                            @keyup.enter="
                                                searchGene(geneToSearch)
                                            "
                                            v-model="geneToSearch"
                                            style="
                                                width: 100%;
                                                position: relative;
                                            "
                                    ...
                                    <research-single-cell-selector
                                        ...
                                        "
                                        @on-update="
                                            geneClick($event.coloredLabels[0])
                                        "
                                    />
                                </div>
                            </div>
                    ...
                    >
                        ...
                        >
                            <div style="display: flex; flex-direction: column">
                                ...
                                <div>
                                    Stratify cell count and gene expression
                                    plots by the chosen trait across cell types.
                                </div>
                            </div>
                            ...
                            <div style="display: flex; gap: 10px">
                                ...
                                <select
                                    ...
                                    @change="
                                        selectSegmentBy(
                                            cellCompositionVars.displayByLabel,
                                            $event.target.value
                                        )
                                    "
                                >
                                    <option value="">--Select--</option>
                                    <option
                                        v-for="(value, key) of traitFields.show"
                                        :value="key"
                                    >
                                        {{ displayLabel(key) }}
                                    </option>
                        ...
                        <div style="display: flex; gap: 20px">
                            ...
                            >
                                ...
                                >
                                    <div style="font-size: 16px">
                                        ...
                                        <template
                                            v-if="
                                                displayFields &&
                                                cellCompositionVars.segmentByLabel &&
                                                displayFields[
                                                    cellCompositionVars
                                                        .segmentByLabel
                                                ].dataType === 'cat'
                                ...
                                >
                                    <research-stacked-bar-plot
                                        :data="
                                            cellCompositionVars.segmentByCounts2
                                        "
                                        :primaryKey="
                                            cellCompositionVars.segmentByLabel
                                                ? cellCompositionVars.segmentByLabel
                                ...
                                <div v-if="contCountResults">
                                    ...
                                    >
                                        <div
                                            v-for="item in contCountResults"
                            ...
                            <div
                                v-if="
                                    geneExpressionVars.expressionStats.length >
                                    0
                                "
                                style="
                                    display: flex;
                                ...
                                >
                                    ...
                                    >
                                        <research-violin-plot
                                            :data="
                                                geneExpressionVars.expressionStats
                                            "
                                            :primaryKey="
                                                geneExpressionVars.selectedLabel
                                            "
                                            :subsetKey="
                                                cellCompositionVars.segmentByLabel
                                            "
                    ...
                    <div style="display: flex; gap: 25px">
                        <div
                            v-if="
                                markers &&
                                (markerGenes || expressionStatsAll.length > 0)
                            "
                            style="
                                display: flex;
                                flex-direction: column;
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <strong style="font-size: 16px">{{
                                            dotPlotCellType != ""
                                                ? `Marker Genes for ${dotPlotCellType}`
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <select
                                                @change="
                                                    showMarkersByCellType(
                                                        $event.target.value
                                                    )
                                                "
                                                v-model="dotPlotCellType"
                                            >
                                                <option value="">All</option>
                                                <option
                                                    v-for="label in markerCellTypes"
                                                    :value="label"
                                                >
                                                    {{ label }}
                                                </option>
                                        ...
                                        <div style="font-size: 13px">
                                            Select a cell type to view its full
                                            marker profile.
                                        </div>
                                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                class="gradient"
                                                :style="`background: linear-gradient(to right, ${colorScalePlasmaColorsArray});`"
                                            ></div>
                                            <div
                                                style="display: flex"
                                                class="marks"
            ...
            <div
                ...
                "
            >
                <research-single-cell-info :data="metadata" />
                    ...
                    <div class="" style="display: flex; gap: 20p; width: 400px">
                        ...
                        >
                            <div
                                ...
                                "
                            >
                                <span style="font-size: 16px; margin: 0 0 5px"
                                    ><span style="font-weight: bold">UMAP</span>
                                    <span style="font-style: italic">{{
                                        geneExpressionVars.selectedGene
                                            ? `${geneExpressionVars.selectedGene}`
                                            : ""
                            ...
                            >
                                ...
                                >
                                    ...
                                    <research-dot-plot
                                        ...
                                        "
                                        :data="
                                            markerGenes || expressionStatsAll
                                        "
                                        data-blah="pct_cells_expression"
                                        yKey="cell_type"
                                        xKey="gene"
...
export default Vue.component("research-single-cell-browser", {
    ...
    data() {
        return {
            ...
            BIendpoints: {
                ...
                coordinates:
                    "/api/raw/file/single_cell/$datasetId/coordinates.tsv.gz",
                expression:
                    "/api/bio/query/single-cell-lognorm?q=$datasetId,$gene",
                markers:
                    "/api/raw/file/single_cell/$datasetId/marker_genes.json.gz",
            },
            ...
            markerDesiredColumns: [
                ...
                },
                {
                    ...
                    sortable: true,
                    formatter: (val) =>
                        typeof val === "number" ? val.toPrecision(3) : "",
                },
                {
    ...
    computed: {
        ...
        portalGroup() {
            ...
            const isHugeamp =
                hostname === "hugeamp.org" || hostname.endsWith(".hugeamp.org");
        ...
        markerGenesSizeKey() {
            ...
            if (this.markerGenes[0].pct_cells_expression)
                return "pct_cells_expression";
        },
        showDepotColumn() {
            //check if metadata has depot column values
            return (
                Array.isArray(this.singleCellMetadata) &&
                this.singleCellMetadata.some(
    ...
    methods: {
        datasetsRowClass(item) {
            ...
            return item.datasetId === this.datasetId
                ? "selected-dataset-row"
                : "dataset-row";
        },
        preprocessBoxPlotData(groupKey, contKey) {
            return scUtils.preprocessBoxPlotData(
        ...
        parseCellCountScatterData(groupKey, contKey, aggregateKey) {
            return scUtils.parseCellCountScatterData(
                this.fields.metadata,
                this.fields.metadata_labels,
                groupKey,
                contKey,
        ...
        parseFacetedScatterData(groupKey, contKey, gene, aggregateKey) {
            return scUtils.parseFacetedScatterData(
                this.fields.metadata,
                this.fields.metadata_labels,
                groupKey,
                contKey,
        ...
        calcCellCounts(a, b, c) {
            return scUtils.calcCellCounts2(
                this.fields,
                this.labelColors,
                a,
                b,
        ...
        async init() {
            ...
            this.showDatasetSelect =
                this.presetsConfig?.["showDatasetSelect"] || false;

            this.layout =
                keyParams["layout"] || this.presetsConfig?.["layout"] || 0;
            ...
            if (!this.datasetId || this.datasetId === "") {
                if (keyParams[this.renderConfig["parameters"]?.datasetId]) {
                    this.datasetId =
                        keyParams[this.renderConfig["parameters"].datasetId];
            ...
            const filterSingleCellMetadata = () => {
                ...
                if (this.allMetadata[0]?.data_type) {
                    filteredMetadata = this.allMetadata.filter(
                        (item) => item.data_type === "single_cell"
                    );
                }
            ...
            this.metadata = this.singleCellMetadata.find(
                (x) => x.datasetId === this.datasetId
            );
            if (!this.metadata) {
            ...
            this.fields = await scUtils.fetchFields(
                fieldsEnpoint,
                this.datasetId
            );
            if (this.fields) {
                if (!this.totalCells) {
                    this.totalCells =
                        this.fields.NAME?.length | this.fields.ID?.length;
                }
            ...
            if (this.layout !== 3) {
                ...
                const coordinatesEnpoint =
                    this.selectedBI + this.BIendpoints.coordinates;
                this.coordinates = await scUtils.fetchCoordinates(
                    coordinatesEnpoint,
                    this.datasetId
                );
                if (this.coordinates) {
            ...
            if (markersEnpoint) {
                ...
                const markersRaw = await scUtils.fetchMarkers(
                    url,
                    this.datasetId
                );
                ...
                const markersNormalized = markersRaw.map((m) => ({
                    ...m,
                    mean_expression:
                        m.mean_expression ?? m.mean_expression_raw ?? 0,
                    pct_cells_expression:
                        m.pct_cells_expression ?? m.pct_nz_group ?? 0,
                ...
                if (this.markers) {
                    if (Array.isArray(this.markers)) {
                        ...
                        this.markersList = [
                            ...new Set(
                                this.markers.map((x) => x.gene.toUpperCase())
                            ),
                        ];
                        this.markerCellTypes = [
                            ...new Set(this.markers.map((x) => x.cell_type)),
                        ];

                        this.markersByGene = scUtils.groupByKey(
                            this.markers,
                            "gene"
                        );
                        this.markersByCellType = scUtils.groupByKey(
                            this.markers,
                            "cell_type"
                        );

                        const topN = 5;
                        const { markersMatrix, markersTable } =
                            this.topNmarkersByCellType(topN);

                        this.geneNames = this.markersList;
                        this.markerGenes = markersMatrix;
                        this.markerGenesTable = markersTable;
                        this.markerGenesMaxMean = d3
                            .max(this.markerGenes.map((d) => d.mean_expression))
                            .toFixed(1);
                        this.markerTableColumns =
                            this.markerDesiredColumns.filter((f) =>
                                this.markerGenes.some(
                                    (row) =>
                                        row[f.key] !== null &&
                                        row[f.key] !== undefined
                                )
                            );
                        this.markersHaveZscores = this.markerGenes.some(
                            (row) =>
                                row.z_score !== null &&
                                row.z_score !== undefined
                        );
                        llog("markers", {
                            markersByGene: this.markersByGene,
                            markersByCellType: this.markersByCellType,
                            transformedData: this.markerGenes,
            ...
            this.colorScalePlasmaColorsArray = d3
                .range(0, 1.01, 0.1)
                .map((t) => this.colorscaleGreyBlue(t))
                .join(", ");
            ...
            if (
                !givenCellTypeLabel ||
                !fieldsList.includes(givenCellTypeLabel)
            ) {
            ...
            if (this.renderConfig["parameters"]?.gene) {
                ...
                const paramGenes = decodeURIComponent(
                    keyParams[this.renderConfig["parameters"].gene]
                );
            ...
            if (!geneRequested) {
                ...
                if (this.markerGenes) {
                    ...
                    await this.getGeneExpression(
                        this.markerGenes[0].gene.toUpperCase(),
                        false
                    );
        ...
        async getGeneExpression(
            ...
            const expressionEnpoint =
                this.selectedBI + this.BIendpoints.expression;
            const expressionResult = await scUtils.fetchGeneExpression(
                expressionEnpoint,
                gene,
                this.datasetId
            );
            ...
            if (expressionResult) {
                if (
                    (this.markerGenes && !this.markersList.includes(gene)) ||
                    !this.markerGenes
                ) {
                ...
                if (addToKeyParams && this.renderConfig["parameters"]?.gene) {
                    keyParams.set({
                        [this.renderConfig["parameters"].gene]: gene,
                    });
                    /*
        ...
        maxCountValue() {
            const max = d3.max(
                this.cellCompositionVars.segmentByCounts2,
                (d) => d.count
            );
            //llog('max', max);
            return max;
        ...
        findCellTypeField(list) {
            return list.reduce(
                (bestMatch, str) => {
                    ...
                    const score =
                        (normalizedStr.includes("cell") ? 1 : 0) +
        ...
        findDonorsField(list) {
            return list.reduce(
                (bestMatch, str) => {
                    const normalizedStr = str.toLowerCase();
                    const score =
                        (normalizedStr.includes("donor") ? 2 : 0) +
        ...
        findSamplesField(list) {
            return list.reduce(
                (bestMatch, str) => {
                    const normalizedStr = str.toLowerCase();
                    const score =
                        (normalizedStr.includes("sample") ? 2 : 0) +
        ...
        topNmarkersByCellType(topN, cellTypeName) {
            ...
            const markersTable = [];
            let topGenes = [];
            for (const [cellType, genes] of Object.entries(
                this.markersByCellType
            )) {
                if (
                    !cellTypeName ||
                    (cellTypeName && cellType === cellTypeName)
                ) {
        ...
        filterDisplayFields(all = false) {
            ...
            if (!this.displayFields) {
                ...
                Object.entries(this.fields.metadata_labels).forEach(
                    ([key, value]) => {
                        if (value.length < 2) {
            ...
            //sort it
            const sortedEntries = Object.entries(this.displayFields).sort(
        ...
        showMarkersByCellType(cellType) {
            if (cellType != "") {
                ...
                const { markersMatrix, markersTable } =
                    this.topNmarkersByCellType(null, cellType);
                this.markerGenes = markersMatrix;
                this.markerGenesTable = markersTable;
            } else {
                const { markersMatrix, markersTable } =
                    this.topNmarkersByCellType(5);
                this.markerGenes = markersMatrix;
                this.markerGenesTable = markersTable;
            }
        },
        selectBioIndex(bi) {
            this.datasetId = null;
            keyParams.set({
                [this.renderConfig["parameters"]?.datasetId]: null,
            });
            this.dataLoaded = false;
        ...
        handleSelectEvent(data) {
            if (data.id === this.sectionId) {
                ...
                if (this.renderConfig["parameters"]?.datasetId) {
                    keyParams.set({
                        [this.renderConfig["parameters"]?.datasetId]:
                            this.datasetId,
                    });
                }
                this.init();
        ...
        selectSegmentBy(display, segment) {
            ...
            llog("segment by:", {
                display,
                segment,
                gene: this.geneExpressionVars.selectedGene,
            });
            g.displayByLabel = display;
            g.segmentByLabel = segment;
            if (segment === "") {
                g.segmentByCounts2 = scUtils.calcCellCounts(
                    this.fields,
                    this.labelColors,
                    g.displayByLabel,
                    g.segmentByLabel
                ...
                if (
                    this.displayFields &&
                    this.displayFields[g.segmentByLabel].dataType === "cat"
                ) {
                    g.segmentByCounts2 = scUtils.calcCellCounts(
                        this.fields,
                        this.labelColors,
                    ...
                    this.displayFields &&
                    this.displayFields[g.segmentByLabel].dataType === "cont"
                ) {
                    this.contCountResults = this.parseCellCountScatterData(
                        g.displayByLabel,
                        g.segmentByLabel,
                        this.donorsField
                    );
            ...
            if (segment === "") {
                ...
                if (
                    this.displayFields &&
                    this.geneExpressionVars.selectedGene &&
                    this.displayFields[g.segmentByLabel].dataType === "cont"
                ) {
                    this.contExprResults = this.parseFacetedScatterData(
                        g.displayByLabel,
                        g.segmentByLabel,
                        this.geneExpressionVars.selectedGene,
                        this.donorsField
        ...
        selectSegmentBy2(display, segment, facet) {
            ...
            g.segmentByCounts2 = scUtils.calcCellCounts2(
                this.fields,
                this.labelColors,
                g.displayByLabel,
                g.segmentByLabel,
        ...
        selectExpressionBy(display, segment) {
            ...
            g.expressionStats = scUtils.calcExpressionStats(
                this.fields,
                this.labelColors,
                this.expressionData[g.selectedGene],
                g.selectedGene,
                g.selectedLabel,
                g.subsetLabel
            );
        ...
        geneClick(gene) {
            ...
            if (this.cellCompositionVars.segmentByLabel === "") {
                ...
                if (
                    this.displayFields &&
                    this.geneExpressionVars.selectedGene &&
                    this.displayFields[this.cellCompositionVars.segmentByLabel]
                        .dataType === "cont"
                ) {
                    this.contExprResults = this.parseFacetedScatterData(
                        this.cellCompositionVars.displayByLabel,
