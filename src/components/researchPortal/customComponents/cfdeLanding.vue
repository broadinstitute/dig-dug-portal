<template>
    <div class="kc-home flex-layout-styles">
            ...
            <div class="hero-wrapper f-col" v-if="this.parsedData">
                ...
                <div class="cf-info" style="display:none">
                    ...
                    <div><b>The Common Fund (CF)</b> is a program within the National Institutes of Health (NIH) designed to
                        ...
                        center. <a href="https://commonfund.nih.gov/" target="_blank">Learn more.</a></div>
                </div>
                ...
                <div class="cfde-info f-col fill-width align-h-center">
                    ...
                    <div class="what-cfde-info" style="display:none">
                        ...
                        <div><b>The Common Fund Data Ecosystem (CFDE)</b> is an initiative under the NIH Common Fund that
                            aims to enhance the accessibility, interoperability, and usability of data generated by Common Fund programs.<br>
                            <a href="https://info.cfde.cloud" target="_blank">Learn more about the data within the CFDE.</a>
                        </div>
                    </div>
        ...
        <div class="home-section-container">
            ...
            <div class="home-section-wrap">
                ...
                <div class="home-section">
                    <template v-for="example in this.examplesData">
                        <div class="example-item f-col" style="gap:20px">
                            <div class="f-row" style="gap:20px">
                                <div class="f-col" style="width:40%; gap:20px;">
                                    <div>
                                        <div class="example-item-type">Analysis</div>
                                        <div class="example-item-analysis">{{ example.analysis }}</div>
                                    </div>
                                    <div>
                                        <div class="example-item-type">Program</div>
                                        <div class="f-row align-v-center" style="gap:10px">
                                            <div class="example-item-logo"><img :src="example.logo"></div>
                    ...
                    <div class="spotlight-prev" data-dir="prev" @click="this.changeExample">
                    ...
                    <div class="spotlight-next" data-dir="next" @click="this.changeExample">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#7c7c7c"
                        stroke-width="1.2">
                            <path
                                d="M5.707 9.71a1 1 0 0 0 0 1.415l4.892 4.887a2 2 0 0 0 2.828 0l4.89-4.89a1 1 0 1 0-1.414-1.415l-4.185 4.186a1 1 0 0 1-1.415 0L7.121 9.71a1 1 0 0 0-1.414 0Z"
        ...
        <div class="home-section-container">
            ...
            <div class="home-section-wrap" style="margin:40px;" v-if="this.parsedData">
                <h3 class="kc">CFDE Workbench</h3>
                <div class="home-section">
                    <div class="f-row">
                        <div class="drc-logo">
                            <img src="https://hugeampkpncms.org/sites/default/files/users/user32/kc_icons/DRC_logo.png">
                        </div>
                        <div class="f-col">
                            <div>Visit our sister resource to query, access, and compute Common Fund datasets.</div>
                            <ul>
...
export default Vue.component("cfde-landing", {
    ...
    methods: {
        ...
        hoverHandler(e) {
            ...
            if (this.currHoverGroup !== 'omics') {
                this.parsedData.map[val]['omics'].forEach(value => {
                    if (value) { document.querySelector(`.omics [data-value="${value}"]`).classList.add('on');}
                });
            }
            if (this.currHoverGroup !== 'entities') {
                this.parsedData.map[val]['entities'].forEach(value => {
                    if (value) { document.querySelector(`.entities [data-value="${value}"]`).classList.add('on');}
                });
            }
            
            if(e.isTrusted){
                document.querySelector('.map-info').style.opacity = 1;
                this.mapTooltip('Program', this.parsedData.map[val].name, this.parsedData.map[val].info);
            }
        },
        hoverHandler2(e) {
        ...
        changeExample(e){
            ...
            if(currExample>0){
                document.querySelector(`.example-item:nth-of-type(${this.currExample})`).classList.remove('active')
            }else{
            ...
            document.querySelector(`.example-item:nth-child(${this.currExample})`).classList.add('active');
        },
        highlightSections(){
        ...
        highlightTopmostTitle() {
            ...
            if (closestTitle) {
                this.sectionTitles.forEach(title => title.classList.remove('active'));
...
.kc-home {
    ...
    .example-item a, .example-item a:visited{
        color:#f26822 !important;
    }
    .example-item-type {
        font-size: 12px;
