                ...
                <div :class="{collapsed: !display_associations}" style="display:flex; flex-direction: column; gap:10px; padding: 0 40px;">
                    <div class="tab-handles">
                        <div class="tab-handle"
                            ...
                            @click="activeTab = 1">Table</div>
                        <div class="tab-handle" 
                            v-if="relevantAssociationsWithGenes"
                            :class="{ active: activeTab === 2 }"
                            @click="activeTab = 2">Visualization</div>
                    </div>
                    <div class="tab-sections">
                        <div class="tab-section" :class="{ active: activeTab === 1 }">
                        ...
                        <div class="tab-section" :class="{ active: activeTab === 2 }">
                            <cfde-mechanism-heatmap v-if="relevantAssociationsWithGenes" :associations="relevantAssociationsWithGenes" />
                        </div>
                    </div>
...
import cfdeMechanismHeatmap from "./cfdeMechanismHeatmap.vue";
...
export default Vue.component("cfde-mechanism-discovery", {
    ...
    data() {
        return {
            ...
            relevantAssociationsWithGenes: null,
            phenotypes_list: [],
...
* Return only the raw JSON array as plain text — no explanations, markdown, or code block syntax.`,
    ...
    methods: {
        ...
        clean(){
            ...
            this.relevantAssociationsWithGenes = null;
        ...
        async mechanismsReveal(){
            ...
            this.relevantAssociationsWithGenes = relevantAssociations;
