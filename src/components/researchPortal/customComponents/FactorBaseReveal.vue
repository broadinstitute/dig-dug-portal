    ...
    data() {
        return {
            ...
            searchApis: {
                ...
                factor: "https://cfde-dev.hugeampkpnbi.org/api/bio/query/pigean-factor?limit=1000&q=$phenotype,cfde",
                phenotypeGeneSetFactor: "https://cfde-dev.hugeampkpnbi.org/api/bio/query/pigean-gene-set-factor?q=$phenotype,cfde,$factor",
                factorGenes: "https://cfde-dev.hugeampkpnbi.org/api/bio/query/pigean-gene-factor?q=$phenotype,cfde,$factor",
                pigeanJoinedGeneSets: "https://cfde-dev.hugeampkpnbi.org/api/bio/query/pigean-joined-gene-set?q=$phenotype,$geneSet,cfde",
            },
            factorData: {},
