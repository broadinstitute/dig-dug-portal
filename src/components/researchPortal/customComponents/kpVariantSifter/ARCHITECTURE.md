...
| Date | Note |
|------|------|
| 2026-09-21 | GWAS-CE token now read from the `token` URL param; postMessage handoff (`variantSifterTokenHandoff.js`) removed |
