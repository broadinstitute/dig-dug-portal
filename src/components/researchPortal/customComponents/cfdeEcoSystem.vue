<template>
	<div>
		...
		<div class="kc-wrap">
			<div class="blurb">
				<div>The Knowledge Center (KC) integrates knowledge generated by ground-breaking research programs in the NIH Common Fund Data Ecosystem. 
					<span>Explore the diagram below to see connections between research programs, the omics data types and biological entities that they span, and their relevance to different research contexts.</span>
				</div>
		...
		<div class="map-bg">
			<div class="map-title">select a research context:</div>
			<div class="map" v-if="this.parsedData">
				<div class="povs">
					<div class="map-label"><div>Research Context</div></div>
				...
				<div class="dccs">
					<div class="map-label"><div>Common Fund Programs</div></div>
				...
				<div class="omics">
					<div class="map-label"><div>Omics Data</div></div>
				...
				<div class="entities">
					<div class="map-label"><div>Searchable Entities</div></div>
		...
		<div class="section" style="background: #f7f6f6;">
			...
			<div class="a quick">
				<div class="b">
					...
					<!--
					<div class="c-body">See metadata, processed data files, api specifications and interoperability assets for
						each Commond Fund program.
					</div>
					-->
					<!--
					<ul>
						<li><p>Query</p>Query across all Common Fund datasets and metadata.</li>
						<li><p>Explore</p>Cloud tools to interrogate data sets from disparate Common Fund programs.</li>
						<li><p>Access</p>Training and outreach to highlight Common Fund data and how to use it effectively.</li>
					</ul>
					-->
				</div>
				<div class="c">
				...
				<div class="b">
					...
					<!--
					<div class="c-body">Get an in-depth summary for each Common Fund program including its research focus, 
						omics data types, tools, resources and more on our <span class="bold">Foundational Knowledge</span> Pages.
					</div>
					-->
					<!--
					<ul>
						<li><p>Curation</p>Contextual, user-friendly, comprehensive results and analysis all in one place.</li>
						<li><p>Synthesis</p>Search by multiple entity types to see what the Common Fund programs have to say.</li>
						<li><p>Analysis</p>Improve your ability to leverage the knowledge generated by Common Fund programs.</li>
					</ul>
					-->
				</div>
			</div>
