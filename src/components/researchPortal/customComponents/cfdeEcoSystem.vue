		...
		<div class="kc-hero">
			<div class="kc-wrap">
				<div class="blurb">
					...
					<div>The Knowledge Center integrates data and knowledge generated by ground-breaking research programs in the NIH Common Fund Data Ecosystem. <br>Use the KC to see curated, synthesized, and analyzed results in a research context.
			...
			<div class="map-bg">
				...
				<div class="map-title2"><span>set search context<span class="btn-icon">?</span></span>To see additional research-related knowledge with your search results.</div>
