            ...
            <table class="table table-hover table-sm">
                <thead>
                    <tr>
                        <th
                            class="column name"
                            v-on:click="setSortKey('title')"
                        >
                            Dataset
                        </th>
                        <th
                            class="column access"
                            v-on:click="setSortKey('field_access')"
                        >
                            Access
                        </th>
                        <th
                            class="column samples"
                            v-on:click="setSortKey('field_samples')"
                        >
                            Samples
                        </th>
                        <th
                        ...
                        <th
                            class="column type"
                            v-on:click="setSortKey('field_data_type')"
                        >
                            Data type
                        </th>
                        <th
                ...
                <tbody>
                    <tr
                        ...
                        v-if="
                            (selectedDatatype == null ||
                                selectedDatatype == row.field_data_type) &&
                            (selectedPhenotype == null ||
                                row.field_phenotypes.includes(
                                    selectedPhenotype
                                )) &&
                    ...
                    >
                        <td class="column name">
                            <a
                                :href="
                                    '/dinspector.html?dataset=' +
                                    row.field_dataset_id
                                "
                                >{{ row.title }}</a
                            >
                        </td>
                        <td class="column access">
                            <span :class="row.field_access">{{
                                row.field_access
                            }}</span>
                        </td>
