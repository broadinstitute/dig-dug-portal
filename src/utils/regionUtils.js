...
export function parseRegion(s,  geneRegionExpand = 0) {
...
// parse a region as either a gene name, ENS ID, or chr:start-stopexport
export async function parseRegionAsync(s, allowGeneLookup = true, geneRegionExpand = 0) {
