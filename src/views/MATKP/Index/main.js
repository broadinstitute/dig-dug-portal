...
new Vue({
                ...
                human:[
                    {
                        ...
                        "ontology": "h7",
                        "category": "visceral",
                        "description": "Fat around the aorta in the abdominal cavity",
                        "pos": [[53.075,39.370]]
                    },{
                        "name": "axillary",
                        "ontology": "h8",
                        ...
                        "ontology": "h10",
                        "category": "visceral",
                        "description": "Fat within the mediastinum (central thoracic cavity)",
                        "pos": [[49.567,46.508]]
                    },{
                        "name": "paravertebral",
                        "ontology": "h11",
                        ...
                        "ontology": "h13",
                        "category": "visceral",
                        "description": "Fat around the pericardium (heart’s protective sac)",
                        "pos": [[55.311,47.092]]
                    },{
                        "name": "retoperitoneal",
                        "ontology": "h14",
                        ...
                        "ontology": "h17",
                        "category": "visceral",
                        "description": "Fat around the adrenal glands, above the kidneys",
                        "pos": [[58.504,56.734]]
                    },{
                        "name": "perirenal",
                        "ontology": "h18",
                        ...
                        "ontology": "h20",
                        "category": "subcutaneous",
                        "description": "Fat beneath the skin in the abdominal area",
                        "pos": [[39.528,62.200]]
                    },{
                        "name": "deep abdominal",
                        "ontology": "h21",
                        "category": "visceral",
                        "description": "Fat beneath the skin but deeper in the abdominal area",
                        "pos": [[41.861,65.946]]
                    },{
                        "name": "mesenteric",
                        "ontology": "h22",
                        "category": "visceral",
                        "description": "Fat within the mesentery (attaches intestines to the abdominal wall)",
                        "pos": [[56.846,62.262]]
                    },{
                        "name": "epiploic",
                        "ontology": "h23",
                        ...
                        "ontology": "h35",
                        "category": "specialized",
                        "description": "Fat providing specific structural support",
                        "pos": [[45.666,188.256],[55.355,182.704]]
                    }
                ],
                "mouse":[
                    {
                        ...
                        "category": "subcutaneous",
                        "description": "Fat in the face and cranial area",
                        "pos": [[41.988,14.864],[43.235,24.597]]
                    },{
                        "name": "dermal",
                        "ontology": "m2",
                        "category": "specialized",
                        ...
                        "category": "visceral",
                        "description": "Fat around the kidneys",
                        "pos": [[30.106,89.080],[48.920,87.582]]
                    },{
                        "name": "mesenteric",
                        "ontology": "m11",
                        "category": "visceral",
    ...
    methods: {
        ...
        displaySpecies(species){
            ...
            const depotsByCategory = this.parseDepotsByCategory(this.selectedSpecies, this.depotsBySpecies);
        ...
        parseDepotsByCategory(species, available){
            ...
            const depotsByCategory = this.depots[species].reduce((acc, depot) => {
        ...
        highlightDepot(e, depot){
            ...
            const el = document.querySelectorAll(`.depot-point[data-depot="${depot.ontology}"]`);
            el.forEach(ell=>{
