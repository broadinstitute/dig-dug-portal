                        ...
                        <div class="glens-step-body">
                            ...
                            <div class="glens-candidate-table glens-candidate-table--variant">
                                ...
                                >
                                    ...
                                    <a :href="variant.link">Open variant</a>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="glens-card glens-card--core">
                        <div class="glens-section-head">
                            <div>
                                ...
                                <h2>How does this phenotype profile appear in CRDC samples, phenotypes, variants, and investigator groups?</h2>
                                <p class="glens-source-note">
                                    These results show how the input phenotype profile is supported within the CRDC cohort.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="glens-tab-row glens-tab-row--evidence">
                            <button
                                type="button"
                                :class="{ 'glens-tab-button--active': activeEvidenceTab === 'overview' }"
                                @click="activeEvidenceTab = 'overview'"
                            >
                                Overview
                            </button>
                            <button
                            ...
                            <button
                                type="button"
                                :class="{ 'glens-tab-button--active': activeEvidenceTab === 'qc' }"
                                @click="activeEvidenceTab = 'qc'"
                            >
                                Annotation-burden QC
                            </button>
                        </div>

                        <div v-if="activeEvidenceTab === 'overview'" class="glens-cohort-tab-panel">
                            <div class="glens-phenotype-profile-panel mt-space">
                                <p class="glens-small-heading">Exact query-match phenotype summary</p>
                                <small>What additional phenotypes recur among samples carrying all user-entered query terms?</small>
                                <p class="glens-source-note">Samples matching all query terms: 132 / 904</p>
                                <div class="glens-profile-table">
                                    <div class="glens-profile-head">
                                        <span>HPO root category</span>
                                        <span>Frequency among exact query-matched samples</span>
                                        <span>Phenotype terms</span>
                                    </div>
                                    <template v-for="row in phenotype.exactQueryMatchedSummary">
                                        <button
                                            :key="`${row.category}-summary`"
                                        ...
                                        >
                                            ...
                                            <span>{{ row.phenotypeTerms.slice(0, 3).join(", ") }}</span>
                                        </button>
                                        <div
                                            v-if="activeExactCategory === row.category"
                                            :key="`${row.category}-terms`"
                        ...
                        <div v-else-if="activeEvidenceTab === 'individual'" class="glens-cohort-tab-panel">
                            ...
                            <div class="glens-core-grid glens-core-grid--cohort mt-space">
                                ...
                                <div class="glens-phenotype-profile-panel">
                                    ...
                                    <div class="glens-profile-metrics">
                                        ...
                                        <span>Expanded/scoring terms matched: <strong>{{ selectedSampleData.scoringTermsMatched }}</strong></span>
                                    </div>
                                    <div class="glens-profile-table">
                                        <div class="glens-profile-head">
                                            <span>HPO root category</span>
                        ...
                        <div v-else-if="activeEvidenceTab === 'coobserved'" class="glens-cohort-tab-panel">
                            <div class="glens-coobserved-panel mt-space">
                                ...
                                <div class="glens-profile-table">
                                    <div class="glens-shared-head">
                                        <span>Co-observed phenotype</span>
                                        <span>Support among matched samples</span>
                                        <span>Domain</span>
                                        <span>Linked candidate signals</span>
                                    </div>
                                    <div
                                        v-for="row in phenotype.coObserved"
                                        :key="row.label"
                                        class="glens-shared-row"
                                    >
                                        ...
                                        <span class="glens-signal-links glens-signal-links--coobserved">
                                            <a
                                                v-for="gene in row.relatedGenes"
                                                :key="`${row.label}-${gene}`"
                                                :href="variantHref(gene)"
                                            >
                                                {{ gene }}
                        ...
                        <div v-else-if="activeEvidenceTab === 'qc'" class="glens-cohort-tab-panel">
    ...
    computed: {
        ...
        selectedSampleData() {
            return this.phenotype.topSamples.find(
                ...
                signals: "KMT2D, CHD7",
                phenotypeProfile: [
                    { category: "Abnormality of the nervous system", terms: "18 terms", phenotypeTerms: ["Developmental delay", "Speech delay", "Seizure", "Hypotonia"] },
                    { category: "Abnormality of head or neck", terms: "9 terms", phenotypeTerms: ["Cleft palate", "Micrognathia", "Low-set ears"] },
                    { category: "Growth abnormality", terms: "8 terms", phenotypeTerms: ["Failure to thrive", "Short stature", "Poor weight gain"] },
                ],
            };
        },
        selectedScorePoint() {
