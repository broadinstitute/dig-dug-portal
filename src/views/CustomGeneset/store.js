...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        setBayesGenescores(state, data) {
            state.bayesGenescores = data || state.bayesGenescores;
        },
    ...
    actions: {
        ...
        async queryBayesGenescores(context, queryString) {
            let address = "https://translator.broadinstitute.org/genetics_provider/bayes_gene/gene_scores";
            let json = await fetch(address, {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json'
            ...
            context.commit("setBayesGenescores", json);
        },
