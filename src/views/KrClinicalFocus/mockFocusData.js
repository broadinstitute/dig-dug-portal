...
export const mockFocusProfiles = {
    ...
    mondo: {
        source: "mondo",
        label: "Kabuki syndrome MONDO disease concept HPO profile",
        mondoId: "MONDO:0007843",
        sourceId: "MONDO:0007843",
        sourceDetail: "Mock profile resolved from a MONDO disease concept to mapped disease HPO annotations.",
        queryExample: "Kabuki syndrome · MONDO:0007843",
        sourceInputLabel: "MONDO disease concept",
        sourceInputPlaceholder: "e.g. Kabuki syndrome or MONDO:0007843",
    ...
    decipher: {
        source: "decipher",
        label: "Kabuki-like DECIPHER syndrome profile",
        decipherId: "DECIPHER:KABUKI-MOCK",
        sourceId: "DECIPHER:KABUKI-MOCK",
        sourceDetail: "Mock profile resolved from a DECIPHER syndrome or disorder profile to HPO annotations.",
        queryExample: "Kabuki-like syndrome · DECIPHER:KABUKI-MOCK",
        sourceInputLabel: "DECIPHER syndrome / disorder profile",
        sourceInputPlaceholder: "e.g. Kabuki-like syndrome or DECIPHER profile ID",
