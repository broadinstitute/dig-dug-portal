		...
		<div class="container-fluid mdkp-body">
			<div class="gene-page-header card mdkp-card">
				<div class="row card-body">
					...
					<div class="col-md-4 gene-page-header-body">
						...
						<span v-if="$parent.selectedPhenotype">{{$parent.selectedPhenotype.description}}</span>
					</div>
				</div>
			</div>
			<div class="card mdkp-card">
				<div class="card-body">
					...
					<div v-for="row in $parent.genes" :class="'gene-with-signal '+row.type">{{row.name}}</div>
				</div>
			</div>
			...
			<div class="card mdkp-card">
				<div v-if="$parent.selectedPhenotype" class="card-body">
					<h4 class="card-title">Top variants for Phenotype: {{$parent.selectedPhenotype.description}}</h4>
