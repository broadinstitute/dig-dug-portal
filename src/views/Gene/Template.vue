<template>
    <div>
      <div class="gene-page-header card mdkp-card">
        <div class="row card-body">
          <div class="col-md-4 gene-page-header-title">
            ...
            <a class="edit-btn" onclick="mdkp.utility.showHideElement('geneSearchHolder');">Edit</a>
          </div>
          <div class="col-md-4 gene-page-header-title">
            Chromosome: Start position - End position
            <a class="edit-btn" onclick="mdkp.utility.showHideElement('regionSearchHolder');">Edit</a>
          </div>
          <div class="col-md-4 gene-page-header-title">
            Phenotype
            <a class="edit-btn" onclick="mdkp.utility.showHideElement('phenotypeSearchHolder');">Edit</a>
          </div>
          <div class="col-md-4 gene-page-header-body">
            <div id="geneSearchHolder" class="gene-page-header-search-holder" style="display: none;">
              Genes UI
            </div>
            <span
          ...
          <div class="col-md-4 gene-page-header-body regionInfo">
            <div id="regionSearchHolder" class="gene-page-header-search-holder" style="display: none;">
              <div class="region-search">
                  <div class="col-md-2 input-wrapper">
                      <input v-model="$store.state.newChrom" type="text" class="form-control input-default">
                  </div>
                  <div class="col-md-4 input-wrapper">
                      <input v-model="$store.state.newStart" type="text" class="form-control input-default">
                  </div>
                  <div class="col-md-4 input-wrapper">
                      <input v-model="$store.state.newEnd" type="text" class="form-control input-default">
                  </div>
                  <div class="col-md-2 input-wrapper">
                      <button id="regionSearchGo" class="btn btn-primary" type="button"
      ...
      <div class="card mdkp-card">
        <div class="card-body">
          <h4 class="card-title">Phenotypes with signal in {{$store.state.chrom}}:{{$store.state.start}} - {{$store.state.chrom}}:{{$store.state.end}}</h4>
          <div
