                ...
                <div class="card mdkp-card">
                    <div class="card-body">
                        ...
                        <!--<documentation
                            ...
                            :content-map="$store.state.bioPortal.documentations"
                        ></documentation>-->
                        <div class="temporary-documentation">See which gene sets from the <a href="https://cfdeknowledge.org/r/kc_landing">Common Fund Data Ecosystem (CFDE)</a> are most relevant to your queried phenotype. This workflow uses a novel Bayesian method, PIGEAN (Priors Inferred from GEne ANnotations), to infer phenotypes, additional genes, and mechanisms that may be related to a list of genes (gene set). CFDE gene sets were generated by the <a href="https://data.cfde.cloud/search/gene%20set/gene_set">CFDE Data Resource Center</a>. To learn more about the method and results, visit the Research Methods page <a href="https://cfdeknowledge.org/r/kc_gsb?source=all&model=cfde">here</a></div>
