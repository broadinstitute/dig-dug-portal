                                    ...
                                    <b-tab title="Gene, region, variant, phenotype or tissue" active>
                                        <div class="col-md-8 offset-md-2" align="center">
                                            <div class="single-search-wrapper">
                                                <research-single-search-v2 :singleSearchConfig="$parent.ssConfig" :phenotypes="$parent.phenotypesInSession
                                                    " :utils="$parent.utilsBox"></research-single-search-v2>
                            ...
                            <div class="row front-search-section">
                                <div class="col-md-8 offset-md-2" align="center">
                                    <div class="single-search-wrapper">
                                        ...
                                        <research-single-search :singleSearchConfig="$parent.ssConfig" :phenotypes="$parent.phenotypesInSession
