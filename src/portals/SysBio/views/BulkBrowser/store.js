...
export default new Vuex.Store({
    ...
    state: {
        ...
        bulkFileUrl: `https://storage.googleapis.com/sysbio-staging-broad-public/single_cell_bulk/`,
        currentComparisons: {},
        selectedAMP: "",
    },
    ...
    actions: {
        async queryBulkFile(context) {
            ...
            if (context.state.selectedDataset !== "") {
                let datasetFile = `${context.state.bulkFileUrl}${context.state.selectedDataset}/dea.tsv.gz`;
        ...
        resetComparison(context) {
            context.commit(
                ...
                context.state.defaultComparison
            );
        },
    },
});
