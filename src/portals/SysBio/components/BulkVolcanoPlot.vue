		...
		<div style="display:flex; gap:5px" class="legends">
			<div style="display:inline-block;" class="legend">
				<div style="display:flex; margin-top:10px; align-items: center;">
                    ...
                    <span class="group-legend-box" style="background-color:#000000">&nbsp;</span><span class="group-legend-name">Not significant</span>
					<span class="group-legend-box" style="background-color:#12bdfe">&nbsp;</span><span class="group-legend-name">Down regulated</span>
					<span class="group-legend-box" style="background-color:#ff00c7">&nbsp;</span><span class="group-legend-name">Up regulated</span>
...
export default Vue.component("bulk-volcano-plot", {
	...
	methods: {
		...
		renderPlot() {
			...
			let height = this.renderConfig['height'] - margin.top - margin.bottom;
