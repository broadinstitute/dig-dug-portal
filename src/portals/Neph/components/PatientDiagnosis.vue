        ...
        <div v-if="rows > 0">
            ...
            <div v-show="tableData.length">
                ...
                <b-pagination
                    ...
                    :total-rows="rows"
                    :per-page="perPage"
                    aria-controls="pdiagnosis"
                ></b-pagination>
            </div>
        </div>
        <div v-else>
            <b-alert show variant="warning" class="text-center">
                <b-icon icon="exclamation-triangle"></b-icon> No diagnosis information found.</b-alert
            >
        </div>
    </div>
</template>
...
export default Vue.component("patient-diagnosis-card", {
	...
	computed: {
        ...
        tableData() {
            if (this.pdiagnosis && this.pdiagnosis.length) {
    ...
    methods: {
        ...
        async searchDiagnosis() {
            ...
            this.pdiagnosis = await query("patient_diagnosis",this.patientId,{},true);
