        ...
        <div v-if="rows > 0">
            ...
            <div v-show="tableData.length">
                ...
                <b-pagination
                    ...
                    :total-rows="rows"
                    :per-page="perPage"
                    aria-controls="plaboratory"
                ></b-pagination>
            </div>
        </div>
        <div v-else>
            <b-alert show variant="warning" class="text-center">
                <b-icon icon="exclamation-triangle"></b-icon> No laboratory information found.</b-alert
            >
        </div>
    </div>
</template>
...
export default Vue.component("patient-laboratory-card", {
	...
	computed: {
        ...
        tableData() {
            if (this.plaboratory && this.plaboratory.length) {
                //console.log("here:"+this.hprecords);
				return this.plaboratory;
			} else {
				return [];
			}
    ...
    methods: {
        ...
        async searchLaboratory() {
            ...
            this.plaboratory = await query("patient_laboratory",this.patientId,{},true);
