        ...
        <div v-if="rows > 0">
            <b-row>
                <b-col class="text-right mb-2">
                    <csv-download
                        ...
                        :data="tableData"
                        filename="padmin_medicine-table"
                    ></csv-download
                ></b-col>
            </b-row>
            <div v-show="tableData.length">
                ...
                <b-pagination
                    ...
                    :total-rows="rows"
                    :per-page="perPage"
                    aria-controls="padmin_medicine"
                ></b-pagination>
            </div>
        </div>
        <div v-else>
            <b-alert show variant="warning" class="text-center">
                <b-icon icon="exclamation-triangle"></b-icon> No Admin Medicine information found.</b-alert
            >
        </div>
    </div>
</template>
...
export default Vue.component("patient-admin_medicine-card", {
	...
	computed: {
        ...
        tableData() {
            if (this.padmin_medicine && this.padmin_medicine.length) {
                //console.log("here:"+this.hprecords);
				return this.padmin_medicine;
			} else {
				return [];
			}
    ...
    methods: {
        ...
        async searchAdminMedicine() {
            //console.log("variant id:" + this.variantId);
            this.padmin_medicine = await query("patient_admin_medicine",this.patientId,{},true);
