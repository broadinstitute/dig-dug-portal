...
import SearchHeaderWrapper from "@/portals/Neph/components/SearchHeaderWrapper.vue";
...
new Vue({
    ...
    computed: {
        ...
        symbolName() {
            //console.log("symbol Name:"+this.$store.getters.canonicalSymbol);
        ...
        dbReference() {
            //console.log("dbReference:"+this.$store.getters["uniprot/dbReference"]);
