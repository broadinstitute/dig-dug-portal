        ...
        <div class="container-fluid mdkp-body">
            ...
            <div class="card mdkp-card">
                <div class="card-body">
                    ...
                    >
                        <h4 class="card-title">
                            Phenotypes observed for variant carriers in the CRDC Aggregation database
                        </h4>
                        <h6>To view information about cohorts in the CRDC Aggregation Database, visit the <href a="research.html?pageid=bch_datasets_n127">dataset page</href></h6>
