...
<template>
    <div id="liger" class="f-col g-40">
        ...
        <!--
        <div>
            <h4 class="bold">Tissues</h4>
            <div class="tabs">
                <div class="tab active" data-tab-id="tissue_a">Tissue A</div>
                <div class="tab" data-tab-id="tissue_b">Tissue B</div>
                <div class="tab" data-tab-id="tissue_c">Tissue C</div>
            </div>
            <div class="tab-section f-col" data-tab-id="tissue_a">
                <div>
                    <h4 class="bold">Cell Types</h4>
                    <div class="tabs">
                        <div class="tab active" data-tab-id="cell_type_a">Cell Type A</div>
                        <div class="tab" data-tab-id="cell_type_b">Cell Type B</div>
                        <div class="tab" data-tab-id="cell_type_c">Cell Type C</div>
                        <div class="tab" data-tab-id="cell_type_d">Cell Type D</div>
                        <div class="tab" data-tab-id="cell_type_e">Cell Type E</div>
                        <div class="tab" data-tab-id="cell_type_f">Cell Type F</div>
                        <div class="tab" data-tab-id="cell_type_g">Cell Type G</div>
                    </div>
                    <div class="tab-section f-col" data-tab-id="cell_type_a">
                        <div class="f-row grow-children">
                            <div>
                                <h4 class="bold">Cell States</h4>
                            </div>
                            <div>
                                <h4 class="bold">Gene Programs</h4>
                            </div>
                        </div>
                    </div>
                </div>
