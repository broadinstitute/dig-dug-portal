        ...
        <div class="pkb-body">
            <div class="card mdkp-card">
                <div class="card-body functional-page">
                    <div id="stats">
                        <span id="stats-header"
                            >Islet perifusion data explorer</span
                        >
                        <span v-if="$parent.filteredMetadata.length > 0">
                            ({{ $parent.donorsWithData.length }} donors with
                            available functional data)</span
                        >
                    ...
                    <div v-if="$parent.filteredMetadata.length > 0">
                        <div class="row">
                            <div class="col-md-3 side-panel-filters">
                                <b-tabs>
                                    <b-tab
                                        title="Filter donor data"
                                        @click="
                                            $parent.useSelectedDonors(false)
                                        "
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                :hidden="!$parent.showAdvanced"
                                            >
                                                <filter-slider
                                                    v-for="advField in Object.values(
                                                        $parent.advancedFields
                                                    ).filter(
                                                        (f) => f.isNumeric
                                                    )"
                                                    :field="advField.key"
                                            ...
                                            >
                                                <div class="invisible-table">
                                                    <b-table
                                                        v-model="
                                                            $parent.filteredDonors
                                                        "
                                                        :items="
                                                            $parent.filteredMetadata.filter(
                                                                filter
                                                            )
                                                        "
                                                    >
                                    ...
                                    <b-tab title="Functional data by trait">
                                        <div>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="color-legend-block"
                                                        :style="`background-color: ${$parent.functionalColorMap[item]};`"
                                                    ></div>
                                                    {{ item }}
                                                </div>
                                            </div>
                                            ...
                                            >
                                                ...
                                                <div class="vlnPlots row">
                                                    <div
                                                        v-for="(
                                                            condition, index
                                                        ) in $parent.vlnConditions.filter(
                                                            (c) =>
                                                                c.startsWith(
                                                                    'INS'
                                                                )
                                    ...
                                    >
                                        <div class="functional-select">
                                            ...
                                            >
                                                ...
                                                <option
                                                    v-for="trait in $parent.assocTraits"
                                                    :value="trait"
                                                >
                                                    {{
                    ...
                    <div>
                        ...
                        >
                            <template #cell(Accession)="r">
                                <a
                                    :href="`https://data.pankbase.org/human-donors/${r.item.Accession}/`"
                                >
                                    {{ r.item.Accession }}
                                </a>
                            </template>
