...
new Vue({
    ...
    data() {
        return {
            ...
            cellTypeField: "Cell Type",
            cellTypeLabel: "Alpha",
            cellType: "alpha",
            model: "mouse_msigdb",

            factorsURL: "https://private.hugeampkpnbi.org/api/bio/query/pankbase-scb-factor?q=",
            genesURL: "https://private.hugeampkpnbi.org/api/bio/query/pankbase-scb-gene-factor?q=",
            cellsURL: "https://private.hugeampkpnbi.org/api/bio/query/pankbase-scb-cell-factor?q=",

            //https://private.hugeampkpnbi.org/api/bio/query/pankbase-scb-factor?q=scRNA,alpha,mouse_msigdb
            //https://private.hugeampkpnbi.org/api/bio/query/pankbase-scb-gene-factor?q=scRNA,alpha,mouse_msigdb,Factor_1
            //https://private.hugeampkpnbi.org/api/bio/query/pankbase-scb-cell-factor?q=scRNA,alpha,mouse_msigdb,Factor_1
            
            factorsData: null,
            factorCellLoadings: null,
            SCloaded: false,
            SC: {
                bioIndex: "https://bioindex-dev.pankbase.org",
                endpoints:{
    ...
    methods: {  
        ...
        async fetchSCdata(){
            ...
            this.SC.cellTypeField = this.cellTypeField;//findCellTypeField(fieldsList);
        ...
        async loadFactors(){
            ...
            const url = `${this.factorsURL}scRNA,${this.cellType},${this.model}`;
        ...
        async loadDetails(row) {
            ...
            const genesURL = `${this.genesURL}scRNA,${this.cellType},${this.model},${factor}`;
            ...
            const cellsURL = `${this.cellsURL}scRNA,${this.cellType},${this.model},${factor}`;
