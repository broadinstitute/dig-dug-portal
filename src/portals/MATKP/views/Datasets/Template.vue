                ...
                <template>
                    ...
                    <div class="f-row content-wrap">
                        ...
                        >
                            ...
                            <div
                                class="f-row align-v-center bold border-bottom"
                                style="height: 32px"
                            >
                                Filters
                            </div>
                            ...
                            >
                                <div class="f-col filter">
                                    <div
                                        ...
                                        :data-input-key="key"
                                        @click="
                                            $parent.showInputOptions($event)
                                        "
                                    >
                                        <div
                                            class="f-row fill-width spread-out no-events"
                                        >
                                            <div
                                                class="bold"
                                                style="
                                    ...
                                    <div
                                        class="f-col input-options hidden"
                                        :data-input-options-key="key"
                                    >
                                        <div
                                        ...
                                        >
                                            <input
                                                ...
                                                :value="option"
                                                v-model="
                                                    $parent.selectedFilters[key]
                                                "
                                            />
                                            <label
                                                :for="`filter-${key}-${option}`"
                                                >{{ option }}</label
                                            >
                                        </div>
                                    </div>
                                ...
                                <div class="input-list">
                                    <div
                                        ...
                                        v-for="value in $parent.selectedFilters[
                                            key
                                        ]"
                                        @click="
                                            $parent.removeInputOption($event)
                                        "
                                        :data-input-key="key"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <option
                                            v-for="option in $parent.pageOptions"
                                            :value="option.value"
                                        >
                                            {{ option.text }}
                                        </option>
                            ...
                            <div class="table-wrap" style="min-height: 500px">
                                ...
                                >
                                    ...
                                    <template #row-details="row">
                                        <div
                                            class="f-col"
                                            style="gap: 5px; margin: 0 0 50px 0"
                                        >
                                            <div
                                                class="f-row subtable"
                                                v-for="field in $parent.subFields"
                                            >
                                                <div
                                                    style="
                                                        min-width: 200px;
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <div
                                                                    ...
                                                                    "
                                                                    @click="
                                                                        $parent.addInputOption(
                                                                            $event
                                                                        )
                                                                    "
                                                                    @mouseover="
                                                                        $parent.highlightTableItems(
                                                                            $event
                                                                        )
                                                                    "
                                                                    @mouseout="
                                                                        $parent.unHighlightTableItems(
                                                                            $event
                                                                        )
                                                                    "
                                                                >
                                    ...
                                    <template #cell(datasetId)="data">
                                        <a
                                            ...
                                            :href="`/cellbrowser2.html?dataset=${data.value}`"
                                    ...
                                    <template #cell()="data">
                                        <template
                                            v-if="
                                                $parent.isFilter(data.field.key)
                                            "
                                        >
                                            <template
