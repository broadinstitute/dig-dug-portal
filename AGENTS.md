...
<!-- Version: 1.0.12 | Generated: 2026-05-19T00:50:11Z | Hash: 5e3d491dc790 -->
...
Variant-specific guidance for the `pankbase-main` build of dig-dug-portal. Extends ../AGENTS.md; root rules and workflows still apply.

Upstream branch: `pankbase-main` of https://github.com/broadinstitute/dig-dug-portal
...
- Branch: `pankbase-main`
- Vue config: `configs/vue.config.PanKbase.js` (variant-specific page set)
...
```bash
git checkout pankbase-main
```

Then follow setup, watch, build, and deploy from ../AGENTS.md.

For local static preview of compiled PanKbase output:
