...
<!-- Version: 1.0.13 | Generated: 2026-06-06T15:26:15Z | Hash: 4a8c28255eea -->
<!-- Sources: dig-dug-portal/cfde-liver-main/AGENTS.md + dig-dug-portal/AGENTS.md -->

# dig-dug-portal — cfde-liver-main

## Variant-Specific Guidance

## Purpose and Intended Audience

Variant-specific guidance for the `cfde-liver-main` build of dig-dug-portal. Extends ../AGENTS.md; root rules and workflows still apply.

Upstream branch: `cfde-liver-main` of https://github.com/broadinstitute/dig-dug-portal
...
- Branch: `cfde-liver-main`
- Vue config: `configs/vue.config.CFDELiver.js` (variant-specific page set)
...
```bash
git checkout cfde-liver-main
```

Then follow setup, watch, build, and deploy from ../AGENTS.md.

For local static preview of compiled CFDE Liver output:
