...
let pages = {
    ...
    krFrontReframe: {
        ...
        title: "KR Front Reframe",
        chunks: ["chunk-vendors", "chunk-common", "krFrontReframe"],
    },
    krSampleReframe: {
        entry: "src/views/KrSampleReframe/main.js",
        template: "public/index.html",
        filename: "krSample_reframe.html",
        title: "KR Sample Reframe",
        chunks: ["chunk-vendors", "chunk-common", "krSampleReframe"],
    },
    krVariantReframe: {
        entry: "src/views/KrVariantReframe/main.js",
        template: "public/index.html",
        filename: "krVariant_reframe.html",
        title: "KR Variant Reframe",
        chunks: ["chunk-vendors", "chunk-common", "krVariantReframe"],
    },
    krPhenotypeReframe: {
